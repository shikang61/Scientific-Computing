...
VectOfDouble IdealGasEoS::conservativeToPrimitive(const VectOfDouble &u) const
{
    ...
    w[VX] = u[MOMX] / u[RHO];
    w[VY] = u[MOMY] / u[RHO];
    w[P] = (m_gamma - 1) * (u[ENE] - 0.5 * u[MOMX] * u[MOMX] / u[RHO] - 0.5 * u[MOMY] * u[MOMY] / u[RHO]);
    return w;
};
...
VectOfDouble IdealGasEoS::primitiveToConservative(const VectOfDouble &w) const
{
    ...
    u[MOMX] = w[RHO] * w[VX];
    u[MOMY] = w[RHO] * w[VY];
    u[ENE] = w[P] / (m_gamma - 1) + 0.5 * w[RHO] * w[VX] * w[VX] + 0.5 * w[RHO] * w[VY] * w[VY];
    return u;
};
...
VectOfDouble StiffenedGasEoS::conservativeToPrimitive(const VectOfDouble &u) const
{
    ...
    w[VX] = u[MOMX] / u[RHO];
    w[VY] = u[MOMY] / u[RHO];
    w[P] = (m_gamma - 1) * (u[ENE] - 0.5 * u[MOMX] * u[MOMX] / u[RHO] - 0.5 * u[MOMY] * u[MOMY] / u[RHO]) - m_gamma * m_p_ref;
    return w;
};
...
VectOfDouble StiffenedGasEoS::primitiveToConservative(const VectOfDouble &w) const
{
    ...
    u[MOMX] = w[RHO] * w[VX];
    u[MOMY] = w[RHO] * w[VY];
    u[ENE] = (w[P] + m_gamma * m_p_ref) / (m_gamma - 1) + 0.5 * w[RHO] * w[VX] * w[VX] + 0.5 * w[RHO] * w[VY] * w[VY];
    return u;
};
...
VectOfDouble JWLEoS::conservativeToPrimitive(const VectOfDouble &u) const
{
    ...
    w[VX] = u[MOMX] / u[RHO];
    w[VY] = u[MOMY] / u[RHO];
    w[P] = JWL_pref(w[RHO]) + m_gamma * (u[ENE] - 0.5 * u[MOMX] * u[MOMX] / u[RHO] - 0.5 * u[MOMY] * u[MOMY] / u[RHO] - w[RHO] * JWL_eref(w[RHO]));
    return w;
};
...
VectOfDouble JWLEoS::primitiveToConservative(const VectOfDouble &w) const
{
    ...
    u[MOMX] = w[RHO] * w[VX];
    u[MOMY] = w[RHO] * w[VY];
    u[ENE] = (w[P] - JWL_pref(w[RHO])) / m_gamma + 0.5 * w[RHO] * w[VX] * w[VX] + 0.5 * w[RHO] * w[VY] * w[VY] + w[RHO] * JWL_eref(w[RHO]);
    return u;
};
